...
class ColletionPackage(models.Model):
    ...
    works = models.ManyToManyField(Work,related_name='works',through='Collection',related_name="collection_package",blank=True)
...
class Collection(models.Model):
    ...
    collection_package = models.ForeignKey(ColletionPackage,on_delete=models.CASCADE,related_name='collection_package') # 文章id
    created_time = models.DateTimeField(auto_now_add=True) # 评论时间
    class Meta:
