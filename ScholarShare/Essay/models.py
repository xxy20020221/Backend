...
class Author(models.Model):
    ...
    institution_display_name = models.CharField("对应的机构名称", max_length=200, db_index=True, default='', null=True)
...
class Work(models.Model):
    ...
    author_display_name = models.CharField(max_length=200,default='')
